...
import { Box, IconButton, Spacer, Spinner, Text, FormControl, Input, Toast, useToast } from "@chakra-ui/react";
      ...
      {selectedChat ? (
        <>
          ...
          <Box  display="flex"
            ...
            <FormControl onKeyDown={sendMessage} isRequired mt={3}><Input variant="filled"
                bg="#E0E0E0"
